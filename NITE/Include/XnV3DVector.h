...
class XNV_NITE_API XnV3DVector : public XnPoint3D
{
public:
	// Constructors
	inline XnV3DVector();
	inline XnV3DVector(XnFloat fX, XnFloat fY, XnFloat fZ);
	inline XnV3DVector(const XnPoint3D& ptOther);
	...
	inline XnV3DVector& operator=(const XnPoint3D& ptRhs);
	...
	inline XnV3DVector& Set(const XnPoint3D& ptOther);
...
XnV3DVector::XnV3DVector(const XnPoint3D& ptOther)
{
	Set(ptOther);
}
...
XnV3DVector& XnV3DVector::operator=(const XnPoint3D& ptRhs)
{
	m_fTolerance = 1e-5f;
...
XnV3DVector& XnV3DVector::Set(const XnPoint3D& ptOther)
{
	return *this = ptOther;
